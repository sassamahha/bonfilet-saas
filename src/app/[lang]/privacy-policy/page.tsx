    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-5 py-12 sm:px-8">
          <h1 className="h2 text-ink">プライバシーポリシー</h1>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">2. 情報の使用目的</h2>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">3. 情報の共有</h2>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">4. 国際的なデータ転送</h2>
            <p>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">5. データの保持</h2>
            <p>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">6. クッキー</h2>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">7. お客様の権利</h2>
            <p>お客様には以下の権利があります：</p>
            <ul className="list-disc pl-5">
              <li>個人情報へのアクセス</li>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">8. セキュリティ</h2>
            <p>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">9. 児童のプライバシー</h2>
            <p>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">10. 本ポリシーの変更</h2>
            <p>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">11. お問い合わせ</h2>
