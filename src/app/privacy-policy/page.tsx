    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-5 py-12 sm:px-8">
          <h1 className="h2 text-ink">Privacy Policy</h1>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">3. Information Sharing</h2>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">4. International Data Transfer</h2>
            <p>
          ...
          <section className="mt-8 space-y-4 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">10. Changes to This Policy</h2>
            <p>
