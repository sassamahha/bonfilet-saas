    ...
    <>
      ...
      <main className="flex-1">
        <div className="mx-auto max-w-3xl px-5 py-12 sm:px-8">
          <h1 className="h2 text-ink">Terms of Service</h1>
          <p className="mt-2 text-sm text-ink-3">Last Updated: January 20, 2026</p>
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">1. About Us</h2>
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            ...
            <h3 className="font-semibold text-ink">2.1 Customization</h3>
            ...
            <h3 className="font-semibold text-ink">2.2 Product Specifications</h3>
            <ul className="list-disc pl-5">
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">3. Orders and Payment</h2>
            <h3 className="font-semibold text-ink">3.1 Order Confirmation</h3>
            <p>
              An order is confirmed only after successful payment processing. You will receive an order confirmation via
              email.
            </p>

            <h3 className="font-semibold text-ink">3.2 Pricing</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink">3.3 Payment</h3>
            <p>
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            ...
            <h3 className="font-semibold text-ink">4.1 Manufacturing and Delivery</h3>
            <ul className="list-disc pl-5">
            ...
            <h3 className="font-semibold text-ink">4.2 Shipping Destinations</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink">4.3 Customs, Duties, and Taxes</h3>
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">5. Refund and Return Policy</h2>
            <h3 className="font-semibold text-ink">5.1 Custom Products - No Returns</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink">5.2 Defective Products</h3>
            ...
            <h3 className="font-semibold text-ink">5.3 Non-Delivery</h3>
            <p>
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            ...
            <h3 className="font-semibold text-ink">6.1 Your Content</h3>
            <p>
            ...
            <h3 className="font-semibold text-ink">6.2 Our Content</h3>
            <p>
          ...
          <section className="mt-8 space-y-3 text-sm leading-7 text-ink-2">
            <h2 className="text-lg font-semibold text-ink">9. Changes to Terms</h2>
            <p>
